...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aria — AI Career Platform" },
      { name: "description", content: "Build resumes, ace interviews, and track applications with an AI career copilot designed for the next generation of work." },
      { property: "og:title", content: "Aria — AI Career Platform" },
      { property: "og:description", content: "Your AI copilot for resumes, interviews, and job hunting." },
